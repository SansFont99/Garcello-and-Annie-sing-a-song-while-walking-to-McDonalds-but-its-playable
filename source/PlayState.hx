	...
	override public function create()
	{
		...
		switch (curStage)
		{
			...
			case 'schoolEvil': //Week 6 - Thorns
				...
				case "mcdonald's": // the golden arch march :D
					var bg:BGSprite = new BGSprite('b6bcf15451c3fac02cfe139fd4749a56', -600, -500, 0.9, 0.9);
					bg.updateHitbox();
					add(bg);
		}
