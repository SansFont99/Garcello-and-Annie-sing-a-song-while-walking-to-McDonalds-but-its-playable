...
class CreditsState extends MusicBeatState
{
	...
	private static var creditsStuff:Array<Dynamic> = [ //Name - Icon name - Description - Link - BG Color
		...
		['atsuover',		'atsuover',			'Artist of Annie and Garcello,\nComposer of The Golden Arch March',				'https://www.youtube.com/channel/UC7ZdjLc8Q9Hst6p3Ofb__3Q',		0xFFFF2043],
		[''],
		['Psych Engine Team'],
		['Shadow Mario',		'shadowmario',		'Main Programmer of Psych Engine',					'https://twitter.com/Shadow_Mario_',	0xFF444444],
